...
"""
Applies the DCAT-AP-DONL 1.1 metadata standard to the CKAN packages and resources.
"""
...
def create_schema(original_schema):
    ...
    multi_field_validation = tk.get_validator('multi_field_validation')
    res_multi_field_validation = tk.get_validator('res_multi_field_validation')
    ...
    original_schema.update({
        ...
        'theme':                    [mandatory, multi_value(), controlled_vocabulary('Overheid:Taxonomiebeleidsagenda'), to_extras],
        ...
        'access_rights':            [recommended, single_value, controlled_vocabulary('Overheid:Openbaarheidsniveau'), to_extras],
        ...
        'spatial_scheme':           [recommended, multi_value(allow_duplicates=True), controlled_vocabulary('Overheid:SpatialScheme'), to_extras],
        ...
        'dataset_status':           [default(u'http://data.overheid.nl/status/beschikbaar'), single_value, controlled_vocabulary('Overheid:DatasetStatus'), to_extras],
        ...
        'changetype':               [default(':created', force=True), controlled_vocabulary('ADMS:Changetype'), to_extras],
    ...
    original_schema['resources'].update({
        ...
        '__after':                  [res_multi_field_validation]
    })
...
def update_schema(original_schema):
    ...
    original_schema.update({
        ...
        'dataset_status':           [recommended, single_value, controlled_vocabulary('Overheid:DatasetStatus'), to_extras],
        'date_planned':             [optional, single_value, date('%Y-%m-%dT%H:%M:%S'), to_extras],
        'issued':                   [recommended, single_value, date('%Y-%m-%dT%H:%M:%S'), to_extras],
        'modified':                 [mandatory, single_value, date('%Y-%m-%dT%H:%M:%S'), to_extras],
        'frequency':                [recommended, single_value, controlled_vocabulary('Overheid:Frequency'), to_extras],
        ...
        'changetype':               [default(':updated', force=True), controlled_vocabulary('ADMS:Changetype'), to_extras],
